...
def main():
    ...
    repo_info_df = pd.read_csv('repo_info.csv', header=None, names=['repo', 'url', 'created', 'subscribers', 'watchers'])
    ...
    entries_df = pd.DataFrame(entries, columns=['creation_date', 'subscribers', 'watchers'])
